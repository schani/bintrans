...
(defconfig liveness0
  ...
  (static-liveness)
  (save-liveness "liveness.~A.liveness0.static.collect")
  ...
  (run
   (unless (exists "out.~A.liveness0.~A.4.count")
     ...
     (save-liveness "liveness.~A.liveness0.~A.0.count")
     (exec "out.~A.liveness0.~A.1.count")
     (save-liveness "liveness.~A.liveness0.~A.1.count")
     (exec "out.~A.liveness0.~A.2.count")
     (save-liveness "liveness.~A.liveness0.~A.2.count")
     (exec "out.~A.liveness0.~A.3.count")
     (save-liveness "liveness.~A.liveness0.~A.3.count")
     (exec "out.~A.liveness0.~A.4.count")
     (save-liveness "liveness.~A.liveness0.~A.4.count")))
  (runs 1))
...
(defconfig liveness1
  ...
  (static-liveness)
  (save-liveness "liveness.~A.liveness1.static.collect")
  ...
  (run
   (unless (exists "out.~A.liveness1.~A.4.count")
     ...
     (save-liveness "liveness.~A.liveness1.~A.0.count")
     (exec "out.~A.liveness1.~A.1.count")
     (save-liveness "liveness.~A.liveness1.~A.1.count")
     (exec "out.~A.liveness1.~A.2.count")
     (save-liveness "liveness.~A.liveness1.~A.2.count")
     (exec "out.~A.liveness1.~A.3.count")
     (save-liveness "liveness.~A.liveness1.~A.3.count")
     (exec "out.~A.liveness1.~A.4.count")
     (save-liveness "liveness.~A.liveness1.~A.4.count")))
  (runs 1))
